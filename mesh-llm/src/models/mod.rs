...
pub use resolve::{
    ...
    installed_model_capabilities, installed_model_display_name, resolve_huggingface_model_identity,
    resolve_model_spec, show_exact_model, show_model_variants_with_progress, ModelDetails,
